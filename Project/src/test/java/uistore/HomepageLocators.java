...
public class HomepageLocators {
    ...
    public static By verifykITCHENAppliancesPackahes = By.xpath("//h1[contains(text(),'KITCHEN APPLIANCE PACKAGES')]");
    ...
    public static By storelocatorclick = By.cssSelector("a[class='sui-ml-1 md:sui-underline'][title='Store Locator']");
