...
public class InformationActionPage {
    ...
    /**
 * Description: Handles hovering and clicking the "DIY" section element on the homepage.
 ...
 */
    ...
    /**
 * Description: Handles clicking the "Kids Workshops" section, verifies text, logs the result, and navigates to "Learn More."
 * @author 10830836 - Ritik
 * Test Case ID: PHDTC-004
 */
    ...
    /**
 * Description: Automates the registration process, including verifying fields and completing the form submission.
 * @author 10830836 - Ritik
 * Test Case ID: PHDTC-004
 */
    ...
    public void clickActionOnFlooring() {
        try {
    ...
    public void clickActionOnBathroom() {
        try {
            helper.waitForElementToBeVisible(InformationPageLocators.flooringclick, 5);
    ...
    public void clickActionOnDoorsAndWindow() {
        try {
            helper.waitForElementToBeVisible(InformationPageLocators.flooringclick, 5);
    ...
    public void clickActionOnHeatingAndCooling() {
        try {
            helper.waitForElementToBeVisible(InformationPageLocators.flooringclick, 5);
     ...
     /**
     *  Description: This method is to click on credit
    ...
    private void moveToCreditOffer() {
     ...
     /**
     *  Description: This method  is to click on apply now in results page 
     *  @author 10830839 -Kaustubh sharma
     * Test case ID:PHDTC-008
     */
    private void applyNow() {
     ...
     /**
     *  Description: This method is to fill the details in the form in the credit the results page
     *  @author 10830839 -Kaustubh sharma
     * Test case ID:PHDTC-008
     */
    private void fillDetails(String first, String last, String email, String number) {
        try {
            helper.waitForElementToBeVisible(InformationPageLocators.firstNameClick, 20);
            helper.sendValues(InformationPageLocators.firstNameClick, first);
            helper.sendValues(InformationPageLocators.lastNameClick, last);
     ...
     /**
     *  Description: This method is to fill the details  in address details page
     *  @author 10830839 -Kaustubh sharma
     *
     *  Test case ID:PHDTC-008
     */
    private void addressDetails(String add, String city, String state, String zip) {
        try {
            helper.sendValues(InformationPageLocators.addressClick, add);
     ...
     /**
     *  Description: This method is to fill the residance status in the  result page
     *  @author 10830839 -Kaustubh sharma
     * Test case ID:PHDTC-008
     */
    private void residenceStatus(String residence, String monthly, String yearly, String dob, String ssn) {
        try {
            ...
            Screenshot.screenshot(Main.driver, "Screenshot");
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    /**
     * Description: This method is to call moveToCreditOffer
     *  @author 10830839 -Kaustubh sharma
     */
    public void moveToCreditOfferCall() {
        moveToCreditOffer();
    }

    /**
     * Description: This method is to call applyNowCall
     *  @author 10830839 -Kaustubh sharma
     */
    public void applyNowCall() {
        applyNow();
    }

    /**
     * Description: This method is to call fillDetailsCall
     *  @author 10830839 -Kaustubh sharma
     */
    public void fillDetailsCall(String first, String last, String email, String number) {
        fillDetails(first, last, email, number);
    }

    
    /**
     * Description: This method is to call addressDetailsCall
     *  @author 10830839 -Kaustubh sharma
     */
    public void addressDetailsCall(String add, String city, String state, String zip) {
        addressDetails(add, city, state, zip);
    }

     /**
     * Description: This method is to call residenceStatusCall
     *  @author 10830839 -Kaustubh sharma
     */
    public void residenceStatusCall(String residence, String monthly, String yearly, String dob, String ssn) {
