...
public class ReporterUtil {
    ...
    private static ExtentReports createReport(String reportName) {
        ...
        TimeZone time = TimeZone.getTimeZone("Asia/Kolkata"); 
        ...
        reporter.config().setReportName("Home Depot Report");
        reporter.config().setDocumentTitle("Home Depot website Automation Report");
